...
final class Version20251218101758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sensor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, date DATETIME NOT NULL, humidity INTEGER NOT NULL, longitude FLOAT NOT NULL, latitude FLOAT NOT NULL, batterie FLOAT NOT NULL, temperature FLOAT NOT NULL)');
